...
The 2026 International AI Safety Report documents a concerning development: some AI models can now distinguish between evaluation and deployment contexts and alter their behavior accordingly. Models have been observed finding loopholes in evaluations and underperforming when they detect they're being tested - a behavior the research community calls "sandbagging."
