...
> Complements [AI Runtime Security](https://airuntimesecurity.io/), which defines the *behavioral* security pattern (Guardrails → Model-as-Judge → Human Oversight). This repo defines the *infrastructure* controls that make that pattern enforceable.
...
The parent framework ([airuntimesecurity.io](https://airuntimesecurity.io/)) defines the behavioral pattern:
