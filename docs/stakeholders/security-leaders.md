---
description: "AIRS framework guide for CISOs and security directors, focused on translating AI runtime risks into actionable security programme requirements."
---
